<?php
    ...
    $result = mysqli_query($conn, "SELECT * FROM destinations WHERE type = 'barlangok'");
?>
...
<div class="back_image">
    ...
    <section class="show-data" id="barlangok" style="padding-top: 4rem";>
