<?php
    ...
    $result = mysqli_query($conn, "SELECT * FROM destinations WHERE type = 'turistika'");
?>
...
<div class="back_image">
    ...
    <section class="show-data" id="turistika" style="padding-top: 4rem";>
